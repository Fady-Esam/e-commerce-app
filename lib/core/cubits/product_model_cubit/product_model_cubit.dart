...
import 'product_model_state.dart';
...
class ProductModelCubit extends Cubit<ProductModelState> {
  ...
  ProductModel? getCurrentProductById({required String productId}) {
  ...
  List<ProductModel> getCtgsPoducts({required String ctgName}) {
    return products.where((e) => e.productCategory.contains(ctgName)).toList();
  }
}
  ...
  //         productImage:
  //             "https://i.ibb.co/NstFstg/7-Samsung-Galaxy-Z-Flip3-5-G.png",
  //         productQuantity: "525",
  //       ),
  //       ProductModel(
  //         //8
  ...
  //         productImage:
  //             "https://i.ibb.co/tcB3HXJ/13-Acer-Predator-Helios-300.webp",
  ...
  //         productImage:
  //             "https://i.ibb.co/xXhSfTh/19-Garmin-Forerunner-945-LTE.png",
